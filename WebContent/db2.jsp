...
<%
	...
	ResultSet r=s8.executeQuery("select * from users where Fname like'"+s+"%';");
	%><tr>
		<td>ID</td>
		<td>Fname</td>
		<td>Lname</td>
	...
	while(r.next())
	{
		...
		<td style="border:1px solid black;"><% out.println(s9); %></td>
		<td style="border:1px solid black;"><%  %><a href="dele.jsp?id=<%=i%>">Delete</a>
		<a href="edit.jsp?id=<%=i%>">Edit</a></td>
		</tr>
